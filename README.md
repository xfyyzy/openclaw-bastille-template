...
- The helper `prepare-stateful-home.sh` materializes symlinked legacy paths (for example `.ssh`, `.gnupg`, `.gitconfig`) into persisted state for both root and OpenClaw runtime HOME.
